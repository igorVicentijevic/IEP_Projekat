...
compiled = compile_source(contract_source, solc_version="0.8.19")
contract_interface = compiled['<stdin>:VotingContract']

VOTING_CONTRACT_ABI = contract_interface['abi']
VOTING_CONTRACT_BYTECODE = contract_interface['bin']
